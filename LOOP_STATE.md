...
- **Why:** Gates green on main (CI 32008667016); weekly re-score trigger/input/issue claims are locked. Remaining Next head is keeping the loop-engine gate path accurate—no new product scope.
