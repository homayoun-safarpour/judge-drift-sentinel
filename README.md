...
Malformed panel JSON, a missing panel file, and a missing `--human-labels`
file (bare ratings needing separate gold) fail the same CLI path: exit 1
with an `error:` stderr line
