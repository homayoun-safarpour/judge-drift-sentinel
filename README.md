...
list / scalar / object), a missing `--human-labels` file, malformed
`--human-labels` JSON, non-object `--human-labels` JSON (top-level array
/ scalar), nested non-object `--human-labels` JSON
